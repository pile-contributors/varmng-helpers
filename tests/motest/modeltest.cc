...
*/
ModelTest::ModelTest (
        QAbstractItemModel *_model, QObject *parent ) :
 ...
 */
void ModelTest::columnCountTest()
{
    // check top row
    QModelIndex topIndex = model->index ( 0, 0, QModelIndex() );
